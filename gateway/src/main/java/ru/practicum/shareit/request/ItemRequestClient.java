...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItemRequest(NewItemRequestDto newItemRequestDto, Long userId) {
        return post("", userId, newItemRequestDto);
    }

    public ResponseEntity<Object> getAllItemRequestsForRequestor(Long userId) {
        return get("", userId);
    }
